      ...
      <div class="table">
        <el-form :inline="true" ref="selectForm" label-width="70px" :model="listQuery.entity">
          ...
          <el-form-item>
            ...
            <el-button style="font-size: 16px;"  type="success" v-has-permi="['room:save']" @click="showDialog(undefined)"> 新增</el-button>
          </el-form-item>
        </el-form>
        <el-table :data="pageInfo.list" v-loading="loading" height="410">
          ...
          <el-table-column label="操作" width="260" fixed="right">
            <template slot-scope="scope">
              <el-button style="font-size: 14px;"  type="primary" v-has-permi="['room:query']" @click="showDialog(scope.row.id)"> 详情</el-button>
              <template>
                <el-popconfirm title="确定删除吗？" @confirm="del(scope.row.id)">
                  <el-button style="margin-left: 8px;font-size: 12px;" v-has-permi="['room:delete']"
                             slot="reference"
                              type="danger"> 删除
                  </el-button>
                </el-popconfirm>
