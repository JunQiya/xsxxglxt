        ...
        <div class="pull-left" :class="isCollapse ? 'nav-collapse' : 'nav'">
            ...
            <el-menu :default-active="activeMenu" class="nav" :collapse="isCollapse" unique-opened>
                <el-row>
                    <el-col :span="5">
                        <!-- 点击logo返回首页 -->
                        <img :class="isCollapse ? 'logo-collapse' : 'logo'" src="https://file.lxxno.cn/2025xszhwz/logo/%E5%AD%A6%E7%94%9F%E5%AE%BF%E8%88%8D.png" alt=""
                            @click="to('/')" />
                    </el-col>
...
export default {
    ...
    methods: {
        // 错误处理函数
        errorHandler() {
            this.icon = "https://file.lxxno.cn/2025xszhwz/logo/%E5%AD%A6%E7%94%9F%E5%AE%BF%E8%88%8D.png";
            console.log(111);
        },
        // 显示邮件对话框
        showMailDialog() {
